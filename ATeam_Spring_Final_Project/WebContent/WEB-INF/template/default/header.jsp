...
<c:set var = "URL" value = "${requestScope['javax.servlet.forward.servlet_path']}" />
	<c:choose>
							...
							<div class="header-column">
								<div class="header-row">
									<div class="header-logo">
										<a href="index.do">
											<img alt="Porto" width="100" height="48" data-sticky-width="82" data-sticky-height="40" data-sticky-top="0" src="resources/img/logo-default-slim-dark.png">
										</a>
									</div>
								</div>
							</div>
							<div class="header-column justify-content-end">
								<div class="header-row">
									<div class="header-nav header-nav-line header-nav-bottom-line header-nav-bottom-line-no-transform header-nav-bottom-line-active-text-light header-nav-bottom-line-effect-1 header-nav-light-text header-nav-dropdowns-dark">
										<div class="header-nav-main header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-text-capitalize header-nav-main-text-size-2 header-nav-main-mobile-dark header-nav-main-effect-1 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													<li class="dropdown">
														<a class="dropdown-item dropdown-toggle" href="index.do">
															Home
														</a>
													...
													<c:if test="${sessionScope.USER_NUM ne null }">
														<li class="dropdown">
															<a class="dropdown-item" data-hash data-hash-offset="130" href="myPage.do">
																MyPage
															</a>
														</li>
													</c:if>
													...
													<li class="dropdown">
														<a class="dropdown-item dropdown-toggle" href="productList.do">
															Couple Shop
														</a>
														<ul class="dropdown-menu">
															<li>
																<a class="dropdown-item" href="productList.do">List</a>
													...
													<li class="dropdown">
														...
														<ul class="dropdown-menu">
															...
															<li><a class="dropdown-item" href="faqForm.do">FAQ</a></li>
										...
										<c:choose>
											<c:when test="${sessionScope.USER_NUM eq null }">
												<a class="btn btn-gradient btn-rounded font-weight-semibold px-4 ms-3" href="loginForm.do">Login</a>
											</c:when>
											<c:otherwise>
												<a class="btn btn-gradient btn-rounded font-weight-semibold px-4 ms-3" href="logout.do">Logout</a>
											</c:otherwise>
										</c:choose>
		...
		<c:when test="${URL eq '/registerForm.do' }">
					...
					<div class="header-container header-container-md container">
						<div class="header-row">
							<div class="header-column">
								<div class="header-row">
									<div class="header-logo">
										<a href="index.do"><img alt="Porto" width="100" height="48" data-sticky-width="82" data-sticky-height="40" data-sticky-top="0" src="resources/img/logo-default-slim.png"></a>
									</div>
								</div>
							</div>
							<div class="header-column justify-content-end">
									...
									<div class="header-nav-features header-nav-features-no-border header-nav-features-lg-show-border order-1 order-lg-2">
										...
										<div class="header-nav-feature header-nav-features-cart d-inline-flex ms-2">
											<a href="#" class="header-nav-features-toggle">
												<img src="resources/img/icons/icon-cart.svg" width="14" alt="" class="header-nav-top-icon-img">
											...
											<div class="header-nav-features-dropdown" id="headerTopCartDropdown">
												<ol class="mini-products-list">
													<li class="item">
														<a href="#" title="Camera X1000" class="product-image"><img src="resources/img/products/product-1.jpg" alt="Camera X1000"></a>
		...
		<c:when test="${URL eq '/productList.do' || URL eq '/productDetail.do'}">
<%-- 		<c:otherwise> --%>
							...
							<div class="header-column w-100">
								<div class="header-row justify-content-between">
									<div class="header-logo z-index-2 col-lg-2 px-0">
										<a href="index.do">
											<img alt="Porto" width="100" height="48" data-sticky-width="82" data-sticky-height="40" data-sticky-top="84" src="resources/img/logo-default-slim.png">
										</a>
									</div>
									...
									<div class="d-flex col-auto col-lg-2 pe-0 ps-0 ps-xl-3">
										...
										<div class="header-nav-features ps-0 ms-1">
											<div class="header-nav-feature header-nav-features-cart header-nav-features-cart-big d-inline-flex top-2 ms-2">
												<a href="#" class="header-nav-features-toggle">
													<img src="resources/img/icons/icon-cart-big.svg" height="30" alt="" class="header-nav-top-icon-img">
													<span class="cart-info">
														<span class="cart-qty">1</span>
													</span>
												</a>
															...
															<ul class="dropdown-menu">
																...
																<li class="dropdown-submenu">
																	...
																	<ul class="dropdown-menu">
																		...
																		<li><a class="dropdown-item" href="index-corporate-9.html">Corporate - Version 9</a></li>
																		<li><a class="dropdown-item" href="index-corporate-10.html"->Corporate - Version 10</a></li>
																		<li><a class="dropdown-item" href="#demos"->More...</a></li>
																	</ul>
																</li>
																<li class="dropdown-submenu">
																	<a class="dropdown-item" href="#">Portfolio</a>
												...
												<ul class="nav nav-pills" id="mainNav">
													...
													<li class="dropdown">
														...
														<ul class="dropdown-menu">
															...
															<li class="dropdown-submenu">
																<a class="dropdown-item" href="#">For Couple Survey</a>
																<ul class="dropdown-menu">
																	<li><a class="dropdown-item" href="index-classic.html">1</a></li>
																	<li><a class="dropdown-item" href="index-classic-color.html">2</a></li>
																	<li><a class="dropdown-item" href="index-classic-light.html">3</a></li>
																	<li><a class="dropdown-item" href="index-classic-video.html">4</a></li>
																	<li><a class="dropdown-item" href="index-classic-video-light.html">5</a></li>
																</ul>
															</li>
															<li class="dropdown-submenu">
																<a class="dropdown-item" href="advice.do">Advice</a>
																<ul class="dropdown-menu">
																	<li><a class="dropdown-item" href="advice.do?advice_start_day=1&advice_start_month=1">1Day to 1Months</a></li>
																	<li><a class="dropdown-item" href="advice.do?advice_start_month=1&advice_start_year=1">1Months to 1Years</a></li>
																	<li><a class="dropdown-item" href="advice.do?advice_start_year=1">1Years to</a></li>
																</ul>
															</li>
														</ul>
													</li>
													<li class="dropdown">
														<a class="dropdown-item dropdown-toggle" href="aboutCouple.do">
															About Couple
														</a>
														<ul class="dropdown-menu">
															<c:choose>
																<c:when test="${sessionScope.USER_COUPLENUM eq 0 || sessionScope.USER_COUPLENUM eq null || USER_ID eq null}">
																	<li>
																		<a class="dropdown-item" href="applicationCouple.do">Application Partner</a>
																	</li>
																</c:when>
																<c:otherwise>
																	<li>
																		<a class="dropdown-item" href="aboutCouple.do">My Partner</a>
																	</li>
																	<li><a class="dropdown-item" href="calendar.do">Calendar</a></li>
																	<li><a class="dropdown-item" href="shop-checkout.html">Checkout</a></li>
																	<li><a class="dropdown-item" href="shop-order-complete.html">Order Complete</a></li>
																</c:otherwise>
															</c:choose>
